...
$query2 = "SELECT time_stamp, category from food_event where user_id='$userid' and date(time_stamp) between '2015-11-01' and '2015-11-30';";
...
$query3 = "select p_stamp, p_condition, m_stamp, m_condition, s_stamp, s_duration from graph_view;";
